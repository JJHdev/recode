...
public class Experience {
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "experience_key_generator")
    @SequenceGenerator(name = "experience_key_generator", sequenceName = "experience_key_seq", allocationSize = 1)
