...
public class Skill {
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "skill_key_generator")
    @SequenceGenerator(name = "skill_key_generator", sequenceName = "skill_key_seq", allocationSize = 1)
